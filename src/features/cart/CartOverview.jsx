...
function CartOverview() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 flex w-full items-center justify-between bg-stone-900 px-4 py-4 text-sm uppercase text-white sm:p-6 md:text-base">
